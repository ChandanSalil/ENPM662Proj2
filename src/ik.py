#!/usr/bin/env python
#This is the code for running inverse kinematics to draw a circle
import rospy
...
def manipulator_control(q1, q2, q3, q4, q5, q6):
    ...
    motor_2 = rospy.Publisher('/tbot1/robot_arm_shoulder_lift_control/command', Float64, queue_size=10)
...
J0 = sp.Matrix([[sp.diff(T06[0,3],theta1),sp.diff(T06[0,3],theta2),sp.diff(T06[0,3],theta3),sp.diff(T06[0,3],theta4),sp.diff(T06[0,3],theta5),sp.diff(T06[0,3],theta6)],
               ...
               [T01[2,2],T02[2,2],T04[#!/usr/bin/env python
#This is the code for running inverse kinematics to draw a circle
import rospy
from geometry_msgs.msg import Twist
from std_msgs.msg import Float64
...
q=sp.Matrix([[-0.215031984094669 + sp.pi/2],       #initializing with joint angles
            [0.215031984094669 - sp.pi/2],
...
for i in range(0,40):
    ...
    J0_inv=(J0_inv.evalf()).inv()        #!/usr/bin/env python
#This is the code for running inverse kinematics to draw a circle
import rospy
from geometry_msgs.msg import Twist
from std_msgs.msg import Float64
